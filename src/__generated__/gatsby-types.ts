...
type pageUsersyanteraworkplacemyBlogStartersrcpages404Tsx3159585216QueryVariables = Exact<{ [key: string]: never; }>;


type pageUsersyanteraworkplacemyBlogStartersrcpages404Tsx3159585216Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

type pageUsersyanteraworkplacemyBlogStartersrcpagesusingTypescriptTsx2907560070QueryVariables = Exact<{ [key: string]: never; }>;


type pageUsersyanteraworkplacemyBlogStartersrcpagesusingTypescriptTsx2907560070Query = { readonly site: Maybe<Pick<Site, 'buildTime'>> };
